...
export default function MiddlePage() {
    return (
        <main className="pt-20">
            ...
            <div className="bg-white py-4 px-4 border-b border-blue-100">
            ...
            <section className="py-20 px-4">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-gradient-to-br from-white to-ivs-blue-light/10 border border-slate-100 rounded-2xl p-8 shadow-lg">
