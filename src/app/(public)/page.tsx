...
export default function HomePage() {
    return (
        <main className="bg-white">
                    ...
                    <FadeUp>
                        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                            ...
                            <div className="relative">
                                <div className="aspect-[4/5] bg-white rounded-[4rem] overflow-hidden shadow-premium-xl relative group border border-slate-100">
                                    <Image
                                    ...
                                    <div className="absolute inset-0 flex items-center justify-center z-10 transition-transform duration-500 group-hover:scale-110">
                                        <button className="w-24 h-24 bg-ivs-blue/20 backdrop-blur-xl border border-white/30 rounded-full flex items-center justify-center shadow-2xl hover:bg-white hover:text-ivs-blue transition group/btn">
                                            <Play className="w-8 h-8 text-white group-hover/btn:text-ivs-blue fill-current ml-1" />
                                        </button>
                                    </div>

                                    {/* Testimonial card floating inside the visual */}
                                    <div className="absolute bottom-8 left-8 right-8 bg-white/90 backdrop-blur-xl rounded-[2.5rem] p-8 shadow-2xl border border-white/20 translate-y-4 group-hover:translate-y-0 transition-transform duration-700">
                                        <p className="text-ivs-navy font-medium text-lg lg:text-xl italic leading-relaxed mb-4">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p className="text-ivs-navy font-bold text-sm">Zainab Siddique</p>
                                                <p className="text-slate-500 text-xs">Parent of Grade 5 Student</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <section className="py-24 sm:py-32 lg:py-40 bg-white border-t border-b border-slate-100 relative overflow-hidden">
                ...
                <div className="container-custom relative z-10">
                    ...
                    <div className="space-y-8 lg:space-y-12">
                        ...
                        <FadeUp delay={0.4}>
                            <div className="group relative overflow-hidden rounded-[3.5rem] bg-white border border-slate-100 shadow-premium hover:shadow-premium-xl transition-all duration-700">
                                <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-ivs-blue/5 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2" />
                                <div className="grid lg:grid-cols-2 relative z-10">
                                    <div className="h-80 lg:h-auto relative overflow-hidden order-first">
                                        <Image
                                            src="https://element451.com/blog/guide-to-student-success"
                                    ...
                                    <div className="p-12 lg:p-20 flex flex-col justify-center">
                                        ...
                                        <h3 className="text-3xl lg:text-5xl font-bold text-ivs-navy mb-6 font-heading">Secondary Program</h3>
                                        <p className="text-slate-500 text-lg mb-10 leading-relaxed">
                                            Elite SSC/Matric preparation with expert faculty and a proven 100% success rate in board examinations.
                                        </p>
                                        <div className="flex items-center gap-12 mb-12">
                                            <div>
                                                <div className="text-4xl font-bold text-ivs-navy font-heading mb-1">98%</div>
                                            ...
                                            <div>
                                                <div className="text-4xl font-bold text-ivs-navy font-heading mb-1">100%</div>
                                                <div className="text-slate-400 text-xs font-bold uppercase tracking-widest">Pass Rate</div>
                                            </div>
                                        </div>
                                        <Link href="/academics/secondary" className="inline-flex items-center gap-4 text-ivs-blue font-bold text-lg hover:text-ivs-accent transition-all group">
                    ...
                    <div className="grid lg:grid-cols-3 gap-12 mb-20">
                        {[
                            ...
                            <FadeUp key={i} delay={i * 0.1}>
                                <div className="group bg-white border border-slate-100 text-slate-800 rounded-[3rem] p-12 hover:bg-ivs-blue-light/50 transition-all duration-700 hover:shadow-premium-xl hover:-translate-y-3">
                                    <div className="flex items-center gap-6 mb-10">
                                        ...
                                        <div>
                                            <div className="font-bold text-xl mb-1 text-ivs-navy">{student.name}</div>
                                            <div className="text-xs font-bold text-ivs-blue uppercase tracking-widest">{student.uni}</div>
                                        </div>
                                    </div>
                                    <p className="text-lg italic leading-relaxed text-slate-600 transition-opacity">
                                        "{student.quote}"
                                    </p>
                                </div>
                            </FadeUp>
            ...
            <section className="py-24 sm:py-32 lg:py-40 relative">
                <div className="container-custom">
                    <div className="bg-ivs-blue rounded-[4rem] p-12 sm:p-20 lg:p-32 text-center relative overflow-hidden shadow-premium-xl">
                        {/* Interactive glow effect */}
                        <div className="absolute inset-0 bg-gradient-to-r from-ivs-blue via-ivs-accent/40 to-ivs-blue opacity-50" />
                        <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-white/30 to-transparent" />

                        <div className="relative z-10 max-w-4xl mx-auto">
                            <span className="inline-block px-4 py-2 bg-white/20 text-white rounded-full text-xs font-bold tracking-[0.2em] uppercase mb-10 border border-white/20">
                                Admissions 2026-27
                            </span>
                            ...
                            <p className="text-lg sm:text-xl lg:text-2xl text-blue-50/90 mb-16 leading-relaxed max-w-3xl mx-auto font-sans font-medium">
                            ...
                            <div className="flex flex-col sm:flex-row gap-6 justify-center">
                                <Link href="/admissions" className="btn-premium !bg-white !text-ivs-blue hover:!bg-ivs-gold hover:!text-ivs-navy shadow-xl hover:shadow-white/20">
                                    Apply Online
                                    <ArrowRight className="w-6 h-6 group-hover:translate-x-2 transition-transform" />
                                </Link>
                                <Link href="/contact" className="btn-glass !bg-transparent !text-white !border-white/30 hover:!bg-white/10">
                                    Campus Visit
                                </Link>
                            </div>
                        </div>
